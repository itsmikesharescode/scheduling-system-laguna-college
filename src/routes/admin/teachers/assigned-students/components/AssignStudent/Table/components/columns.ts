...
import type { AssignableStudentsPageSchema } from '../data/schemas.js';
import {
  TableColumnHeader,
  TableRowActions,
  TableSectionsCell,
...
export const columns: ColumnDef<AssignableStudentsPageSchema>[] = [
  {
    id: 'select',
    header: ({ table }) =>
  ...
  },
  {
    ...
    header: ({ column }) => {
      return renderComponent(TableColumnHeader<AssignableStudentsPageSchema, unknown>, {
        column,
        title: 'Student ID'
      });
    },
