  ...
  <AlertDialog.Content>
    <AlertDialog.Header>
      ...
      <AlertDialog.Description>
        This action will permanently delete the selected teacher account and all associated data.
        Once deleted, this information cannot be recovered. Please confirm your decision to proceed.
      </AlertDialog.Description>
    </AlertDialog.Header>
    <AlertDialog.Footer>
      <Button
